...
"""
__author__ = "Anthony Mazzawi"
__email__ = "amazzawi@mail.uoguelph.ca"
...
# Function will connect to the mysql database
def connect(db):  
...
# Create the routes table in mysql
...
def insert(db, info):
  ...
  for x in range(1, len(info)):
    ...
    #if route != "50_StoneRoadExpress" and route != "56_VictoriaExpress-30MinServiceSept2014" and route != "57_HarvardExpress":
