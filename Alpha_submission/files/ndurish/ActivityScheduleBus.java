...
/**
 * This class defines the Activity which builds the stop and route selection page
 *      @author: Nic Durish.
 *
 ...
 */
public class ActivityScheduleBus extends ActionBarActivity
        implements AdapterView.OnItemClickListener {

    //Variables to hold the selected route name and position
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Get a reference to the listView, set adapter and click listener
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                //Build route list if user is currently on a stop list
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (selectedRoute.equals("Transit Schedule")){
            ...
            //Build routelist & set title based on selected route
